      ...
      <div className="client">
        ...
        <div className="client-logo-section row">
          <div className="col-4 col-md-3 col-lg-2">
            <Image src={theme === 'dark' ? ClientLogoDark1 : ClientLogoLight1} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2">
            <Image src={theme === 'dark' ? ClientLogoDark2 : ClientLogoLight2} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2">
            <Image src={theme === 'dark' ? ClientLogoDark3 : ClientLogoLight3} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2">
            <Image src={theme === 'dark' ? ClientLogoDark4 : ClientLogoLight4} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2">
            <Image src={theme === 'dark' ? ClientLogoDark5 : ClientLogoLight5} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2">
            <Image src={theme === 'dark' ? ClientLogoDark6 : ClientLogoLight6} className="client-logo" />
          </div>
          {/* hide for small and medium screen */}
          <div className="ms-auto col-6 col-md-3 col-lg-2 d-none d-none d-lg-block d-xl-block">
            <Image src={theme === 'dark' ? ClientLogoDark7 : ClientLogoLight7} className="client-logo" />
          </div>
          <div className="col-6 col-md-3 col-lg-2 d-none d-none d-lg-block d-xl-block">
            <Image src={theme === 'dark' ? ClientLogoDark8 : ClientLogoLight8} className="client-logo" />
          </div>
          <div className="me-auto col-6 col-md-3 col-lg-2 d-none d-none d-lg-block d-xl-block">
            <Image src={theme === 'dark' ? ClientLogoDark9 : ClientLogoLight9} className="client-logo" />
          </div>
          {/* show for small and medium screen */}
          <div className="col-4 col-md-3 col-lg-2 d-block d-lg-none d-xl-none">
            <Image src={theme === 'dark' ? ClientLogoDark7 : ClientLogoLight7} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2 d-block d-lg-none d-xl-none">
            <Image src={theme === 'dark' ? ClientLogoDark8 : ClientLogoLight8} className="client-logo" />
          </div>
          <div className="col-4 col-md-3 col-lg-2 mx-auto d-block d-lg-none d-xl-none">
            <Image src={theme === 'dark' ? ClientLogoDark9 : ClientLogoLight9} className="client-logo" />
          </div>
        </div>
      </div>
