...
import VeImage1 from "../../../../assets/img/services/videoediting/ve-img-1.png";
import VeImage2 from "../../../../assets/img/services/videoediting/ve-img-2.png";
import VeImage3 from "../../../../assets/img/services/videoediting/ve-img-3.png";
      ...
      <Container>
        <div className="row mt-5 ms-0" style={{ maxWidth: "100vw" }}>
          <div className="col-md-7 col-lg-7 col-xl-7 pb-3">
            <img className="about-our-img" src={VeImage2} alt="img" />
          </div>
